...
public class LogoConfig {
	...
	private String logoClasspath; //logo 图片的路径

	public LogoConfig(String logoClasspath) {
		this.logoClasspath = logoClasspath;
	}
	...
	public BufferedImage LogoMatrix(BufferedImage matrixImage) throws IOException {
		 ...
		 * 读取Logo图片
		 */
		BufferedImage logo = ImageIO.read(LogoConfig.class.getResourceAsStream(logoClasspath));
