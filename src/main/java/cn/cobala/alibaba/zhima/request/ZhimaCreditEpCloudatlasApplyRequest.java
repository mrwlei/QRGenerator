...
import cn.cobala.alibaba.zhima.response.ZhimaCreditEpCloudatlasApplyResponse;

/**
 * ALIPAY API: zhima.credit.ep.cloudatlas.apply request
 * 
 * @author auto create
 * @since 1.0, 2016-07-19 10:06:10
 */
public class ZhimaCreditEpCloudatlasApplyRequest implements ZhimaRequest<ZhimaCreditEpCloudatlasApplyResponse> {
	...
	* 商户传入的业务流水号。此字段由商户生成，需确保唯一性，用于定位每一次请求，后续按此流水进行对帐。生成规则: 固定30位数字串，前17位为精确到毫秒的时间yyyyMMddHHmmssSSS，后13位为自增数字。
	...
	public String getApiMethodName() {
		return "zhima.credit.ep.cloudatlas.apply";
	}
	...
	public Class<ZhimaCreditEpCloudatlasApplyResponse> getResponseClass() {
		return ZhimaCreditEpCloudatlasApplyResponse.class;
	}
}
