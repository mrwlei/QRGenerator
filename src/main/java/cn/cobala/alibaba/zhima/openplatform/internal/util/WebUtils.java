...
import cn.cobala.alibaba.zhima.openplatform.FileItem;
...
public abstract class WebUtils {
    ...
    private static final String DEFAULT_CHARSET = ZhimaConstants.CHARSET_UTF8;
    ...
    public static String doPost(String url, String ctype, byte[] content, int connectTimeout,
        ...
        try {
            try {
                ...
                ZhimaLogger.logCommError(e, url, map.get("app_id"), map.get("method"), content);
                throw e;
            }
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                ZhimaLogger.logCommError(e, conn, map.get("app_id"), map.get("method"), content);
                throw e;
            }
    ...
    public static String doPost(String url, Map<String, String> params,
        ...
        try {
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                ZhimaLogger.logCommError(e, url, map.get("app_key"), map.get("method"), params);
                throw e;
            }
            ...
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                ZhimaLogger.logCommError(e, conn, map.get("app_key"), map.get("method"), params);
                throw e;
            }
